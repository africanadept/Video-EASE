...
hh1=animatedline(lb(1,2),lb(1,1),'Color','m','LineStyle','-.');
hh2=animatedline(rb(1,2),rb(1,1),'Color','g','LineStyle','-.');
hh3=animatedline(es(1,2),es(1,1),'Color','r','LineStyle','-.');
hh4=animatedline(eb(1,2),eb(1,1),'Color','c','LineStyle','-.');
